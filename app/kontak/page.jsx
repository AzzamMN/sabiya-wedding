...
export const metadata = {
  title: 'Kontak | Sabiya Wedding',
  description: 'Hubungi Sabiya Wedding untuk mewujudkan pernikahan impian Anda.',
};
      ...
      <div className={`${styles.contactGrid} reveal`}>
        ...
        <div className={`glass-panel ${styles.infoCard}`}>
          ...
          <div className={styles.infoItem}>
            ...
            <p className={styles.infoText}>
              <a href="tel:+6281234567890" className="text-gold">+62 812 3456 7890</a>
            </p>
          </div>
          <div className={styles.infoItem}>
